...
%---------------------------------------------------------------------	
		...
		\section{Les différentes étapes} 
				...
				\subsection{Générateur aléatoire de caractères} 
					...
					La variable n'étant qu'incrémentée par le timer, meme si la valeur de \emph{positionCaract} est changée entre l'entrée dans la condition et l'affectation, la condition reste vraie.\\
		...
		\section{La version finale du jeu}
			...
			\begin{figure}[!ht]
				...
				\label{fig:final}
			\end{figure}
			De part le mode de gestion que nous avons choisi, qui correspond à une interprétation possible des exigences du sujet, la seule variable partagée entre les threads EventDispatchThread et TimerPerso est la variable \emph{positionCaract}, qui stocke la position en X du caractère à l'écran.\\
